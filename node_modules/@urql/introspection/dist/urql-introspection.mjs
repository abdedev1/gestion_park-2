...
var getIntrospectedSchema = i => {
  ...
  if ("object" == typeof i && "__schema" in i) {
    return i;
  }
  var t = a({
    document: n(r({
...
var minifyIntrospectionQuery = (e, a = {}) => {
  ...
  var o = u.filter((e => {
    switch (e.name) {
     ...
     default:
      return i && "SCALAR" === e.kind || t && "ENUM" === e.kind || s && "INPUT_OBJECT" === e.kind || "OBJECT" === e.kind || "INTERFACE" === e.kind || "UNION" === e.kind;
    }
