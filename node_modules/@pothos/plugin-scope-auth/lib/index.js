...
_export(exports, {
    PothosScopeAuthPlugin: function() {
...
class PothosScopeAuthPlugin extends _core.BasePlugin {
    wrapResolve(resolver, fieldConfig) {
        ...
        const authorizedOnSubscribe = !!((_this_builder_options_scopeAuthOptions = this.builder.options.scopeAuthOptions) === null || _this_builder_options_scopeAuthOptions === void 0 ? void 0 : _this_builder_options_scopeAuthOptions.authorizeOnSubscribe) && typeConfig.kind === 'Subscription';
        ...
        const runTypeScopesOnField = !nonRoot || !((_ref = (_typeConfig_pothosOptions_runScopesOnType = typeConfig.pothosOptions.runScopesOnType) !== null && _typeConfig_pothosOptions_runScopesOnType !== void 0 ? _typeConfig_pothosOptions_runScopesOnType : (_this_builder_options_scopeAuthOptions1 = this.builder.options.scopeAuthOptions) === null || _this_builder_options_scopeAuthOptions1 === void 0 ? void 0 : _this_builder_options_scopeAuthOptions1.runScopesOnType) !== null && _ref !== void 0 ? _ref : false);
    ...
    wrapSubscribe(subscriber, fieldConfig) {
        ...
        if (!((_this_builder_options_scopeAuthOptions = this.builder.options.scopeAuthOptions) === null || _this_builder_options_scopeAuthOptions === void 0 ? void 0 : _this_builder_options_scopeAuthOptions.authorizeOnSubscribe) || typeConfig.kind !== 'Subscription') {
            return subscriber;
        }
    ...
    wrapIsTypeOf(isTypeOf, typeConfig) {
        ...
        var _typeConfig_pothosOptions_runScopesOnType, _ref;
        const shouldRunTypeScopes = (_ref = (_typeConfig_pothosOptions_runScopesOnType = typeConfig.pothosOptions.runScopesOnType) !== null && _typeConfig_pothosOptions_runScopesOnType !== void 0 ? _typeConfig_pothosOptions_runScopesOnType : (_this_builder_options_scopeAuthOptions = this.builder.options.scopeAuthOptions) === null || _this_builder_options_scopeAuthOptions === void 0 ? void 0 : _this_builder_options_scopeAuthOptions.runScopesOnType) !== null && _ref !== void 0 ? _ref : false;
