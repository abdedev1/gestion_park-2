...
__export(client_exports, {
  Provider: () => import_next.UrqlProvider,
  cacheExchange: () => cacheExchange,
  createClient: () => createClient,
  useQuery: () => import_next.useQuery
});
module.exports = __toCommonJS(client_exports);
var import_next = require("@urql/next");
...
var createClient = (opts) => {
  var _a;
  const ssr = (0, import_next.ssrExchange)();
  const options = __spreadProps(__spreadValues({}, opts), {
    suspense: (_a = opts.suspense) != null ? _a : true,
    exchanges: opts.exchanges || [cacheExchange, ssr, import_next.fetchExchange]
  });
  return { client: (0, import_next.createClient)(options), ssr };
};
